 ...
 * @author Kasun
 */
public class AdminAddNurseUtil {

    private static AdminAddNurseUtil adminAddNurseUtil;
    private NursePaneDataDTO nursePaneDataDTO;

    public AdminAddNurseUtil(VBox vBox) {
        nursePaneDataDTO = new NursePaneDataDTO(
                ...
                (JFXTextField) ((AnchorPane) (vBox.getChildren().get(0))).lookup("#txtNurseID")
        );
    }

    public static AdminAddNurseUtil getAdminAddNurseUtil(VBox vBox) {
        if (adminAddNurseUtil == null) {
            adminAddNurseUtil = new AdminAddNurseUtil(vBox);
        }
        return adminAddNurseUtil;
    }

    public NursePaneDataDTO getAddNurse() {
        return nursePaneDataDTO;
    }
}
