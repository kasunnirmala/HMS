 ...
 * @author Kasun
 */
public class ReserveNormalRoom extends AdminAddNormalRoom {

    private RoomService roomService;
    private RoomTypeService roomTypeService;
    private RoomReserveDTO roomReserveDTO;

    public ReserveNormalRoom(String roomNo) throws Exception {
        super(roomNo);
    ...
    public void disablePanel() throws Exception {
        ...
        anchorPane.setStyle("-fx-background-image:url('/hospital/assets/normalReserve.png')");
